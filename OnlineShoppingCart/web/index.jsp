            ...
            <table border="1" width="30%" cellspacing="1" cellpadding="1" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="text-align: left;">
                                <%= "<input type=\"text\" name=\"" + pd.getMovie() + "\" value=\"\" size=\"10\" style=\"text-align: center;\" id = \"" + pd.getMovie() + "_Quantity\" />"%>
                            </div>
                        </td>
                    </tr>
                    <%}%>
        ...
        if (!session.isNew()) {
            ...
            while (sessionAttrList.hasMoreElements()) {
                ...
                if (!singleAttr.contains("WELD_S_HASH")) {
                    out.println("document.getElementsById(\"" + singleAttr + "\").check = true");
                    out.println("document.getElementsById(\"" + singleAttr + "_Quantity\").value = \"" + session.getAttribute(singleAttr) + "\"");
                }
            }
            out.println("</script>");
        }
